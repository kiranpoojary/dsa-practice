...
public class CountBridges {
    ...
    // Space Complexity: O(V+2E) + O(3V), where V = no. of vertices, E = no. of
    // edges. O(V+2E) to store the graph in an adjacency list and O(3V) for the
    // three arrays i.e. tin, low, and vis, each of size V.
    ...
    public static void main(String[] args) {
        ...
        List<List<Integer>> bridges = CountBridges.criticalConnections(n, connections);
